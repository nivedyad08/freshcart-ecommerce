...
//product
const cpUpload = productUpload.fields([
...
adminRoute.get(
  "/add/product",
  authCheck.isAdmin,
  adminController.addProductView
);
adminRoute.get(
  "/product/edit/:productId",
  authCheck.isAdmin,
  adminController.editProductView
);
adminRoute.post(
  "/product/edit/:productId",
  cpUpload,
...
adminRoute.get(
  "/add/category",
  authCheck.isAdmin,
  adminController.addCategoryView
);
adminRoute.post(
  "/add/category",
...
adminRoute.get(
  "/create/coupon",
  authCheck.isAdmin,
  adminController.createCouponView
);
adminRoute.post(
  "/create/coupon",
  authCheck.isAdmin,
...
adminRoute.get(
  "/top-sales/report",
  authCheck.isAdmin,
  adminController.topSalesReport
);
